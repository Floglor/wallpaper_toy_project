...
class UnsplashImages {
  ...
  UnsplashImages({this.total, this.totalPages, this.results});

  UnsplashImages.fromJson(Map<String, dynamic> json) {
    total = json['total'];
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    links = json['links'] != null ? new PicLinks.fromJson(json['links']) : null;
    likes = json['likes'];
...
class PicLinks {
  ...
  PicLinks.fromJson(Map<String, dynamic> json) {
    self = json['self'];
    html = json['html'];
    photos = json['photos'];
    likes = json['likes'];
